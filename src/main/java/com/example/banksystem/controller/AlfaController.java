...
public class AlfaController implements Initializable {
...
//        AlfaController.Sum=Integer.valueOf(entersum.getText());
//        AlfaController.Term=Integer.valueOf(enterterm.getText());
        ...
        Optional<BankType> bankType = bankTypeDao.get(2);       // <=====

        Names.setText("Name bank : " + bankType.get().getName());       // <=====
        minsum.setText("Minimal sum : " + bankInfoList.get(1).getMinSum());
        Maxsum.setText("Maximal sum : " + +bankInfoList.get(1).getMaxSum());
        minterm.setText("Minimal term : " + +bankInfoList.get(1).getMinTerm());
        maxterm.setText("Maximal term : " + +bankInfoList.get(1).getMaxTerm());
        percent.setText("Percent : " + bankInfoList.get(1).getPercent());
    }
    ...
    public void continueButtonOnAction(ActionEvent event) {
        try {
            ...
            Optional<BankInfo> bankInfoOpt = bankInfoList.stream().filter(t -> t.getBankId() == 2)      // <=== Міняєш АЙДІ банка
                    .findAny();
